...
public class BadgeView extends TextView {
     ...
     */
	public BadgeView(Context context, View target, int badgeType) {
     ...
     */
	public BadgeView(Context context, TabWidget target) {
		this(context, null, android.R.attr.textViewStyle, target);
	}
...
//		badgeColor = 0xff460050;
        badgeColor = 0xffed4e4e;
	...
	private void applyTo(View target) {
		...
		container.addView(target, 0, new LayoutParams(
	...
	private void applyLayoutParams() {
		...
		lp.setMargins(dipToPixels(28), 0, 0, 0);
